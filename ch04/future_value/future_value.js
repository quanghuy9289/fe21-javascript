...
var processEntries = function () {
    ...
    {
      $("investment_error").firstChild.nodeValue = "This field must be greater than 0 and less than 100000.";
      $("future_value").value = "";
    };
    if (rate == 0 || rate >= 15)
    {
      $("rate_error").firstChild.nodeValue = "This field must be greater than 0 and less than 15.";
      $("future_value").value = "";
    };
    if (years == 0 || years >= 50)
    {
      $("years_error").firstChild.nodeValue = "This field must be greater than 0 and less than 50.";
      $("future_value").value = "";
    };
